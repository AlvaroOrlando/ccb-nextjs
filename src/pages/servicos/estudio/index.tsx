...
import StudioTableContainer from "@/components/pages/Estudio/StudioTableContainer";
import StudioImgContainer from "@/components/pages/Estudio/studioImgContainer";
import PainelContainer from "@/components/Containers/PainelContainer";
import Text from "@/components/Global/Text";
import EstudioForm from "@/components/pages/Estudio/estudioForm";
...
export default function Estudio(){
  ...
  const servico = router.query.servico as string;
