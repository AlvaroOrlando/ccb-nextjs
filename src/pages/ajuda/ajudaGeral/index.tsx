export default function AjudaGeral(){
    return (
          <div className={`bg`}>
            <div className={`mainContainerGlobal mt-2`}>
              <div style={{width:'100%'}}>
                <h1 className={`titulosGlobal mb-0`} >
                    <a style={{color: '#cd1012'}} href="https://www.clubedoscompositores.com.br/supergeral_ajuda.asp"> 
                    Ajuda
                    </a> {'>'} Ajuda Geral 
                </h1>
                    ...
                    <div id="collapseTwo" className={`accordion-collapse collapse`} aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                      <div className={`accordion-body`}>
                        <h4>Como me associar ao CCB?</h4>
                          <ol>
                            <li> Entre em nosso site (www.clubedoscompositores.com.br) e clique em <strong>&quot;Associar ao CCB&quot;</strong>.</li>
                            ...
                            <li id="matricula-ajuda"> Pague a Matrícula para a página ficar definitivamente no ar com suas músicas tocando para o mundo.</li>
                          </ol>
                          <p className={`alert alert-danger`} role="alert">Para se desfiliar, envie uma carta com sua assinatura pedindo sua desfiliação, juntamente com a carteirinha cortada ao meio, para: CCB - Caixa Postal 2063 - CEP 11060-970 SP. Para sua segurança, Não serão aceitos pedidos de desfiliação por email.</p>
                          <p>Caso não ache o que procura, envie um e-mail
                              para <b>webmaster@clubedoscompositores.com.br.</b></p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div id="collapseTen" className={`accordion-collapse collapse`} aria-labelledby="headingTen" data-bs-parent="#accordionExample">
                        <div className={`accordion-body`}>
                          ...
                          <ol>
                            ...
                            <p>http://www.clubedoscompositores.com.br:6799/mewebmail</p>
                        ...
                        <h4>Não consigo imprimir boleto
                          ...
                          <p>no Banco Bradesco agência 0525
                            ...
                            <p>e envie um email confirmando a data para:
                              <b>contato@clubedoscompositores.com.br</b></p>
                      </div>
                    </div>
                  </div>
